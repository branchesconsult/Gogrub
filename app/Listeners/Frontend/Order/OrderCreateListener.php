...
class OrderCreateListener implements ShouldQueue
{
    ...
    public function handle(OrderCreateEvent $event)
    {
        ...
        sendPushNotificationToFCMSever($chefDeviceToken, 'You have a new order', 'chefOrderCreated', null, $event->order);
        sendPushNotificationToFCMSever($customerDeviceToken, 'Your order has been placed successfuly', 'customerOrderCreated', null, $event->order);
        return false;
    }
