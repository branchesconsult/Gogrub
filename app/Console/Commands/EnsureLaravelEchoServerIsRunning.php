...
class EnsureLaravelEchoServerIsRunning extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'laravel-echo-server:checkup';
    /**
    ...
    {
        if (!file_exists(__DIR__ . '/laravel-echo-server.pid')) {
            return false;
        }
        return file_get_contents(__DIR__ . '/laravel-echo-server.pid');
    }
    ...
    {
        file_put_contents(__DIR__ . '/laravel-echo-server.pid', $pid);
    }
    ...
    private function startQueueListener()
    {
        ...
        $command = 'laravel-echo-server start'; // 5.6 - see comments
        $pid = exec($command);
        return $pid;
    }
}
