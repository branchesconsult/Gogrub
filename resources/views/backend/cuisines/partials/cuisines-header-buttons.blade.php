<!--Action Button-->
@if( Active::checkUriPattern( 'admin/cuisines' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.cuisines.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.cuisines.all' ) }}
            </a>
        </li>
        @permission( 'create-cuisine' )
            <li>
                <a href="{{ route( 'admin.cuisines.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.cuisines.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
