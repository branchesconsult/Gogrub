<!--Action Button-->
@if( Active::checkUriPattern( 'admin/orderstatuses' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.orderstatuses.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.orderstatuses.all' ) }}
            </a>
        </li>
        @permission( 'create-orderstatus' )
            <li>
                <a href="{{ route( 'admin.orderstatuses.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.orderstatuses.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
